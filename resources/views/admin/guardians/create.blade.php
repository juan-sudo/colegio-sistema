...
@section("content")
<h1 class="text-xl font-bold mb-4">Nuevo apoderado</h1>
<form method="POST" action="{{ route("admin.guardians.store") }}">
    ...
    <div class="bg-white rounded shadow p-4 grid gap-4 max-w-2xl">
        ...
        <div>
            ...
            <input type="text" name="phone_whatsapp" value="{{ old("phone_whatsapp") }}" class="w-full border rounded p-2" required>
